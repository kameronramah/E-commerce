...
class AppFixtures extends Fixture
{
    public function load(ObjectManager $manager): void
    {
        ...
        $basketball1->setPrice(184.99);
        $basketball1->setName('Air Jordan XXXVI');
        $basketball1->setDescription('La Air Jordan XXXVI n\'est pas seulement la dernière sortie de la franchise emblématique ; c’est l\'expression de la détermination et de l\'énergie qui ont déclenché une révolution dans l\'univers du basketball.Il s\'agit de l\'une des chaussures de basketball Air Jordan les plus légères à ce jour, avec une empeigne en tissage léno épurée mais robuste, renforcée par un ruban en TPU.Elle est également équipée d\'une unité Zoom Air Strobel sur toute la longueur, cousue directement sur l\'empeigne et combinée avec une unité Zoom Air sous l\'avant-pied, offrant une sensation de retour d\'énergie et de réactivité digne des élites du basketball.Entrez sur le terrain avec la certitude que quoi que vous fassiez, vous le ferez tout en légèreté.');
